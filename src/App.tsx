...
const advice3 = [
  ...
  "Exercise every single day, even when you dont feel like it.",
  "Dont spend more money than you make.",
  "Drink orange juice every day.",
  "Love at first sight is not a fable.",
  "Having a bad job is better than having no job at all.",
  "Eat around the mold; dont go wasting food.",
  ...
  "Dont ever be afraid to be your true self.",
  ...
  "If youre faced with a problem, dont delay trying to figure it out. But if theres no way to figure it out, you have to forget about it.",
  "Make sure youre doing what you love; dont be afraid to follow those dreams you have for yourself.",
  ...
  "Have common sense. Think about the most reasonable answer to every situation. If you dont have common sense, youre a bust.",
...
function App() {
  ...
  return (
    <div className="App">
      <header className="App-header" style={{ justifyContent: "space-evenly" }}>
        <div
          style={{
            width: "100%",
            height: "50vh",
        ...
        >
          <p className={animate2} style={{ opacity: 0.1, fontSize: "20px" }}>
            {QUOTES_DATA[(currentIndex - 1) % QUOTES_DATA.length]}
          </p>
          <p className={animate} style={{ opacity: textVisibilty }}>
            <span style={{ color: "red", position: "absolute" }}>
              {highlightedQuotes}
            </span>
            {currentQuotes}
          </p>
          <p className={animate1} style={{ opacity: 0.1, fontSize: "20px" }}>
            {QUOTES_DATA[(currentIndex + 1) % QUOTES_DATA.length]}
          </p>
        </div>
